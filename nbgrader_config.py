...
config.CourseDirectory.db_url = str(URL(
    drivername=os.environ['DB_DRIVER'], username=os.environ['DB_GRADER_USER'],
    password=os.environ['DB_GRADER_PASSWORD'], host=os.environ['DB_HOST'],
